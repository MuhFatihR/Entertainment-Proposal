...
$keputusan = $_REQUEST['keputusan_filter'] ?? "";
    ...
    // GET DATA
    $getData = "SELECT 
                    parcel.id, parcel.keputusan, parcel.no_parcel,
    ...
    foreach ($list as $filter) {
        ...
        $row[] = '<button type="button" class="btn btn-sm btn-primary showDetail" data-id="' . $filter['id'] . '"> Detail </button>'; // Value ini akan dikirim ke AJAX (js) 
        $data[] = $row;
    }
