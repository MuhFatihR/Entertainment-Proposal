...
$queryExisting = "SELECT id_employee FROM peserta_b WHERE id_pengajuan_b = '$id_pengajuan'";
...
if($totalExist > $totalData){
    ...
    $sqlDeleteExisting = "DELETE FROM peserta_b WHERE id_pengajuan_b = '" . $id_pengajuan . "' LIMIT " . $selisih;
    ...
    for ($i = 0; $i < $selisih; $i++) {
        $sqlinsertExisting = "INSERT INTO peserta_b (id_pengajuan_b, id_employee, nama_peserta_perusahaan, direktorat_peserta_perusahaan, has_updated) VALUES ($id_pengajuan, 0, 'temp', 'temp', '0')";
...
$queryUpdatePesertastatus = "UPDATE peserta_b
                            SET has_updated = '0'
                            WHERE id_pengajuan_b = '". $id_pengajuan ."'";
